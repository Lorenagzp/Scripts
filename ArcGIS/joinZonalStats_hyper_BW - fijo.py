...
try:
    ...
    #if Grid == '#' or not Grid:
    gridName = "H140117_BW"
    Grid = bwGdbPath + "\\" + gridName # provide a default value if unspecified
    ...
    tablesPath = bwDataPath + "\\" + "140117\\L3"
    ...
    L_merge = bwVectoresPath + "\\" + "merge_temp" + "\\" + "l_merge.shp"
    
    # Process: Merge
    arcpy.Merge_management(bf_Lx_1+";"+bf_Lx_2, L_merge)
    print "merging " + bf_Lx_1 + ";" + bf_Lx_2
    ...
    for b in bandNames:
        ...
        bandField = "B" + str(i)
        print bandField
        L_Stats_table = tablesPath + "\\" + bandField + ".dbf"
        print L_Stats_table
        Field_Name_Calculate_field = gridName + "." + bandField
        print Field_Name_Calculate_field
        Expression_Calculate_field = "!"+bandField+".Mean!"
        print Expression_Calculate_field
        Expression_Select_layer = "\""+bandField+".Mean\" IS NOT NULL"
        ...
        arcpy.SelectLayerByAttribute_management(gridLayer, "NEW_SELECTION", Expression_Select_layer)
