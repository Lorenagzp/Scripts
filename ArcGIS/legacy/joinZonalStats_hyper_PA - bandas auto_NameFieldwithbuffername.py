...
try:
    ...
    desc = arcpy.Describe(L_merge)
    gPath = desc.path
    buffSource = str(gPath) + "\\" + L_merge
    arcpy.AddMessage("Grid source: " + buffSource)
    buffName = desc.baseName
    arcpy.AddMessage("Grid basename: " + buffName)
	#This is to match the name that the field "Name" has, because it go the name of the feature I joined"
    buff_no_null=buffName[0:-4]
    print bf_Lx_1
    ...
    Zone_field_and_join_Field = buff_no_null+"_"+id_field
    gridLayer = "gridLayer"
    ...
    for b in bandNames:
        ...
        arcpy.AddJoin_management(gridLayer, id_field, zs, Zone_field_and_join_Field, "KEEP_ALL")    
