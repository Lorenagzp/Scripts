...
try:      
    ...
    ## START:INPUTS ##
    ##Hard coded this
    csvExtractThis = "C:\\Dropbox\\data\\AD\\ad_sam\\extract_sam_ad_h.csv" ##########################
    ...
    gdb = "C:\\Dropbox\\data\\AD\\ad_sam\\shp\\adsam.gdb\\"
    ...
    id_field = "id" #####################
    log= "C:\\Dropbox\\data\\AD\\AD-STARS\\extract_sam_ad_log.txt" ############################
    ## END:INPUTS ##
