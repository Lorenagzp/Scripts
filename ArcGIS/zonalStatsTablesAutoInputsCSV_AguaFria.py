...
try:      
    ...
    csvExtractThis = "C:\\Dropbox\\data\\AD\\AD-AF\\data\\ad_aff_extract.csv" ##########################
    #imgWs="G:\\AD15_16\\" #imageBaseLocation
    imgWs="G:\\AD15_16\\AF\\Processed\\CompB_geo\\" #test ###################################
    ...
    gdb = "C:\\Dropbox\\data\\AD\\AD-AF\\shp\\ad_af.gdb\\"
    ...
    tws ="C:\\Dropbox\\data\\AD\\AD-AF\\shp\\ad_af.gdb\\" #For AF ######Not worinkg... it save in shp folder#######
    ...
    #id_field = "id" #####################
    id_field = "plot_trial" #####################
    log= "C:\\Dropbox\\data\\AD\\AD-AF\\data\\ad_aff_log.txt" ############################
    ## END:INPUTS ##
    ...
    buf="bfs" #we use the buffered plot features to extract the stats #############
    bw8="_af" #default trial ####################################
    ## END:VARIABLES ##
