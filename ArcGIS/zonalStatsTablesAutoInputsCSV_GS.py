...
try:      
    ...
    csvExtractThis = "C:\\Dropbox\\data\\AD\\AD_seed\\pre-data\\ad_extract_m_sed.csv" ##########################
    #imgWs="G:\\AD15_16\\" #imageBaseLocation
    imgWs="G:\\AD15_16\\" #test ###################################
    ...
    gdb = "C:\\Dropbox\\data\\AD\\AD_seed\\shp\\ad_sed.gdb\\"
    ...
    tws ="C:\\Dropbox\\data\\AD\\AD_seed\\shp\\ad_sed.gdb\\" #For AF ######Not worinkg... it save in shp folder#######
    ...
    #id_field = "id" #####################
    id_field = "id" #####################
    log= "C:\\Dropbox\\data\\AD\\AD_seed\\pre-data\\ad_sed_extract_log.txt" ############################
    ## END:INPUTS ##
    ...
    mosaicFolder = {
        ...
        "t": ("cel","cel"),
        "a": ("cel","cel"),
        "c": ("ndvi_geo","nvi"), #specific dor this time
    }
    arcpy.env.workspace = gdb
    ext=".bsq" #extension of the rasters
    buf="plt" #we use the buffered plot features to extract the stats #############
